...
Since we are on an early stage of development, no version of the software is considered stable yet.

When the first stable release is published, this notice will be updated.

## Updates

Security patches and bug fixes are only applied to the latest stable release.
